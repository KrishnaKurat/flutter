...
import '/components/no_content_charter_widget.dart';
...
import 'charter_bookings_page_model.dart';
export 'charter_bookings_page_model.dart';

class CharterBookingsPageWidget extends StatefulWidget {
  const CharterBookingsPageWidget({super.key});

  static String routeName = 'charterBookingsPage';
  static String routePath = '/charterBookingsPage';

  @override
  State<CharterBookingsPageWidget> createState() =>
      _CharterBookingsPageWidgetState();
}

class _CharterBookingsPageWidgetState extends State<CharterBookingsPageWidget> {
  late CharterBookingsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharterBookingsPageModel());
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: EditseatsWidget(
                                                                                  ...
                                                                                  vacancyref: listViewBookingsRecord.vacancy,
                                                                                  previousseatalloted: listViewBookingsRecord.seatallocated,
                                                                                ),
                                                                              ),
                                                                            ),
                                                                          );
                                                                    ...
                                                                    unawaited(
                                                                      () async {
                                                                        await listViewBookingsRecord
                                                                          ...
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'filled_vacancies': FieldValue.increment(-(listViewBookingsRecord.seatallocated)),
                                                                            },
                                                                          ),
                                                                        });
                                                                      }(),
