...
import 'charter_r_e_q_u_e_s_t_v_model.dart';
export 'charter_r_e_q_u_e_s_t_v_model.dart';

class CharterREQUESTVWidget extends StatefulWidget {
  const CharterREQUESTVWidget({super.key});

  static String routeName = 'charterREQUESTV';
  static String routePath = '/charterREQUESTV';

  @override
  State<CharterREQUESTVWidget> createState() => _CharterREQUESTVWidgetState();
}

class _CharterREQUESTVWidgetState extends State<CharterREQUESTVWidget> {
  late CharterREQUESTVModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharterREQUESTVModel());
