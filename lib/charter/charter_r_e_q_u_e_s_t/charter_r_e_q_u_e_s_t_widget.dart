...
import '/charter/charterallotseat/charterallotseat_widget.dart';
...
import 'charter_r_e_q_u_e_s_t_model.dart';
export 'charter_r_e_q_u_e_s_t_model.dart';

class CharterREQUESTWidget extends StatefulWidget {
  const CharterREQUESTWidget({super.key});

  static String routeName = 'charterREQUEST';
  static String routePath = '/charterREQUEST';

  @override
  State<CharterREQUESTWidget> createState() => _CharterREQUESTWidgetState();
}

class _CharterREQUESTWidgetState extends State<CharterREQUESTWidget> {
  late CharterREQUESTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharterREQUESTModel());
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        await listViewRequestsRecord
                                                                          ...
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'filled_vacancies': FieldValue.increment(-(listViewRequestsRecord.seatsrequired)),
                                                                            },
                                                                          ),
                                                                        });
                                                                      },
