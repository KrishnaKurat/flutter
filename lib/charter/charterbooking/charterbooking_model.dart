...
import '/index.dart';
import 'charterbooking_widget.dart' show CharterbookingWidget;
import 'package:flutter/material.dart';

class CharterbookingModel extends FlutterFlowModel<CharterbookingWidget> {
  ///  State fields for stateful widgets in this page.

  final formKey = GlobalKey<FormState>();
  // Stores action output result for [Firestore Query - Query a collection] action in charterbooking widget.
  List<CharterLoadRecord>? charter;
  ...
  String? _textController1Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Please specify the load';
    }
