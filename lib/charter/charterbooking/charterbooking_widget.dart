...
import '/charter/charter_booking_comp/charter_booking_comp_widget.dart';
import '/charter/charter_request_comp/charter_request_comp_widget.dart';
...
import 'charterbooking_model.dart';
export 'charterbooking_model.dart';

class CharterbookingWidget extends StatefulWidget {
  const CharterbookingWidget({super.key});

  static String routeName = 'charterbooking';
  static String routePath = '/charterbooking';

  @override
  State<CharterbookingWidget> createState() => _CharterbookingWidgetState();
}

class _CharterbookingWidgetState extends State<CharterbookingWidget> {
  late CharterbookingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CharterbookingModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault(currentUserDocument?.role, '') != 'Admin') {
        _model.charter = await queryCharterLoadRecordOnce(
          queryBuilder: (charterLoadRecord) => charterLoadRecord.where(
            'unit',
            isEqualTo: currentUserDisplayName,
          ),
        );
        if ((_model.charter != null && (_model.charter)!.isNotEmpty) == false) {
          await CharterLoadRecord.collection
              .doc()
              .set(createCharterLoadRecordData(
                currentLoad: 0.0,
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<List<RoutesRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<RoutesRecord>
                                            gridViewRoutesRecordList =
                                            snapshot.data!;
                                        if (gridViewRoutesRecordList.isEmpty) {
                                          return Center(
                                        ...
                                        return GridView.builder(
                                          ...
                                          itemCount:
                                              gridViewRoutesRecordList.length,
                                          itemBuilder:
                                              (context, gridViewIndex) {
                                            final gridViewRoutesRecord =
                                                gridViewRoutesRecordList[
                                                    gridViewIndex];
                                            return InkWell(
                                              splashColor: Colors.transparent,
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Container(
                                                            height: MediaQuery
                                                                ...
                                                                0.7,
                                                            child:
                                                                CharterBookingCompWidget(
                                                              start:
                                                                  gridViewRoutesRecord
                                                                      .startpoint,
                                                              end:
                                                                  gridViewRoutesRecord
                                                                      .endpoint,
                              ...
                              if (valueOrDefault(
                                ...
                                Align(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) =>
                                        StreamBuilder<List<CharterLoadRecord>>(
                                      stream: queryCharterLoadRecord(
                                        queryBuilder: (charterLoadRecord) =>
                                            charterLoadRecord.where(
                                          'unit',
                                          isEqualTo:
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<CharterLoadRecord>
                                            columnCharterLoadRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final columnCharterLoadRecord =
                                            columnCharterLoadRecordList
                                                    .isNotEmpty
                                                ? columnCharterLoadRecordList
                                                    .first
                                                            ...
                                                            children: [
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        TextSpan(
                                                                          text:
                                                                            ...
                                                                            columnCharterLoadRecord?.currentLoad.toString(),
                                                                            '0',
                                                                          ),
                                                                          style:
                                                                              TextStyle(
                                                              ...
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  await columnCharterLoadRecord!
                                                                      .reference
                                                                      .update(
                                                                          createCharterLoadRecordData(
                                                                    currentLoad:
                                                                        valueOrDefault<
                                                                            double>(
                                                                ...
                                                                unawaited(
                                                                  () async {
                                                                    await columnCharterLoadRecord!
                                                                        ...
                                                                        .update(
                                                                            createCharterLoadRecordData(
                                                                      offrDl: int.tryParse(_model
                                                                          .textController2
                                                                          .text),
                                                                      jCODl: int.tryParse(_model
                                                                          .textController3
                                                                          .text),
                                                                      oRDl: int.tryParse(_model
                                                                          .textController4
                                                                          .text),
                                                                      totalDL:
                                                                          valueOrDefault<
                              ...
                              children: [
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.goNamed(
                                        CharterREQUESTWidget.routeName,
                                        extra: <String, dynamic>{
                                          '__transition_info__': TransitionInfo(
                                            hasTransition: true,
                                            transitionType:
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.goNamed(
                                        CharterBookingsPageWidget.routeName,
                                        extra: <String, dynamic>{
                                          '__transition_info__': TransitionInfo(
                                            hasTransition: true,
                                            transitionType:
                        ...
                        child: Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => FFButtonWidget(
                              onPressed: () async {
                                context.goNamed(
                                  CharterREQUESTVWidget.routeName,
                                  extra: <String, dynamic>{
                                    '__transition_info__': TransitionInfo(
                                      hasTransition: true,
