...
import 'storesview_r_e_q_u_e_s_t_model.dart';
export 'storesview_r_e_q_u_e_s_t_model.dart';

class StoresviewREQUESTWidget extends StatefulWidget {
  const StoresviewREQUESTWidget({super.key});

  static String routeName = 'storesviewREQUEST';
  static String routePath = '/storesviewREQUEST';

  @override
  State<StoresviewREQUESTWidget> createState() =>
      _StoresviewREQUESTWidgetState();
}

class _StoresviewREQUESTWidgetState extends State<StoresviewREQUESTWidget> {
  late StoresviewREQUESTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoresviewREQUESTModel());
