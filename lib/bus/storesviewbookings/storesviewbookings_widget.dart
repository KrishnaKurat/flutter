...
import 'storesviewbookings_model.dart';
export 'storesviewbookings_model.dart';

class StoresviewbookingsWidget extends StatefulWidget {
  const StoresviewbookingsWidget({super.key});

  static String routeName = 'storesviewbookings';
  static String routePath = '/storesviewbookings';

  @override
  State<StoresviewbookingsWidget> createState() =>
      _StoresviewbookingsWidgetState();
}

class _StoresviewbookingsWidgetState extends State<StoresviewbookingsWidget> {
  late StoresviewbookingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoresviewbookingsModel());
