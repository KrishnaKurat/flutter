...
import 'storesview_r_e_q_u_e_s_t_v_model.dart';
export 'storesview_r_e_q_u_e_s_t_v_model.dart';

class StoresviewREQUESTVWidget extends StatefulWidget {
  const StoresviewREQUESTVWidget({super.key});

  static String routeName = 'storesviewREQUESTV';
  static String routePath = '/storesviewREQUESTV';

  @override
  State<StoresviewREQUESTVWidget> createState() =>
      _StoresviewREQUESTVWidgetState();
}

class _StoresviewREQUESTVWidgetState extends State<StoresviewREQUESTVWidget> {
  late StoresviewREQUESTVModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoresviewREQUESTVModel());
