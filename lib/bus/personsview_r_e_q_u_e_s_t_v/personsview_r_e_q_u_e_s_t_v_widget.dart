...
import 'personsview_r_e_q_u_e_s_t_v_model.dart';
export 'personsview_r_e_q_u_e_s_t_v_model.dart';

class PersonsviewREQUESTVWidget extends StatefulWidget {
  const PersonsviewREQUESTVWidget({super.key});

  static String routeName = 'personsviewREQUESTV';
  static String routePath = '/personsviewREQUESTV';

  @override
  State<PersonsviewREQUESTVWidget> createState() =>
      _PersonsviewREQUESTVWidgetState();
}

class _PersonsviewREQUESTVWidgetState extends State<PersonsviewREQUESTVWidget> {
  late PersonsviewREQUESTVModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PersonsviewREQUESTVModel());
                                                                        ...
                                                                        await showDialog<bool>(
                                                                              ...
                                                                              builder: (alertDialogContext) {
                                                                                return AlertDialog(
                                                                                  ...
                                                                                  content: Text('Do you want to remove your request ?'),
                                                                                  actions: [
                                                                                    TextButton(
