...
class _EditUserPageWidgetState extends State<EditUserPageWidget> {
  ...
  void initState() {
    ...
    _model.currPassTextController ??= TextEditingController();
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 10.0),
                          child: Text(
                            'Change your Username and Password from here',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            validator: _model
                                                .currPassTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                        Padding(
                                        ...
                                        TextFormField(
                                          controller:
                                              _model.confirmEmailTextController,
                                          focusNode:
                                              _model.confirmEmailFocusNode,
                                          autofocus: false,
                                          ...
                                          keyboardType:
                                              TextInputType.emailAddress,
                                          validator: _model
                                              .confirmEmailTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ],
                                    ),
                                        ...
                                        if (_model
                                          ...
                                          if (_model.newEmailTextController
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  'cannot use same username again',
                                            ...
                                            _model.reauthenticateEmail =
                                                await actions.reauthenticate(
                                              _model
                                                  .currPassTextController.text,
                                              currentUserEmail,
                                            );
                                            _shouldSetState = true;
                                            if (_model.reauthenticateEmail!) {
                                              if (_model.newEmailTextController
                                                  .text.isEmpty) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'confirm username should be same as new username!',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelSmall
                                                        .override(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.oldPassTextController,
                                            focusNode: _model.oldPassFocusNode,
                                            autofocus: false,
                                            textInputAction:
                                                TextInputAction.next,
                                            obscureText:
                                                !_model.oldPassVisibility,
                                            decoration: InputDecoration(
                                              labelText: 'Current Password',
                                              labelStyle: FlutterFlowTheme.of(
                                                      context)
                                            ...
                                            validator: _model
                                                .oldPassTextControllerValidator
                                                .asValidator(context),
                                          ),
                                        ),
                                        Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (_model.newPassTextController.text ==
                                            _model.confirmPassTextController
                                                .text) {
                                          _model.reauthenticatePass =
                                              await actions.reauthenticate(
                                            _model.oldPassTextController.text,
                                            currentUserEmail,
                                          );
                                          _shouldSetState = true;
                                          if (_model.reauthenticatePass!) {
                                        ...
                                        safeSetState(() {
                                          _model.oldPassTextController?.clear();
